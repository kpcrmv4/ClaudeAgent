...
const AGENT_FEATURES: Record<string, { hat?: string; accessory?: string; emoji: string }> = {
  ...
  "data-scientist":  { hat: "headphones", accessory: "chart", emoji: "🤖" },
